        ...
        private void LoadNewFile()
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                try
                {
                    ...
                    {
                        excel_con.Open();
                        using (OleDbDataAdapter oda = new OleDbDataAdapter("SELECT * FROM [ItemName$A1:AG]", excel_con))//main table == productmaster
                        {
