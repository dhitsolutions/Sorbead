...
{
    public partial class ListPOS : Form
    {
        ...
        public ListPOS()
        {
            ...
            LVbill.Columns.Add("Name", 100, HorizontalAlignment.Left);
            ...
            LVbill.Columns.Add("Count", 80, HorizontalAlignment.Left);
        }

        public ListPOS(Master master, TabControl tabControl)
        {
            // TODO: Complete member initialization
            InitializeComponent();
            LVbill.Columns.Add("Date", 100, HorizontalAlignment.Center);
            LVbill.Columns.Add("Bill No", 0, HorizontalAlignment.Left);
            LVbill.Columns.Add("Bill No", 80, HorizontalAlignment.Left);
            LVbill.Columns.Add("Account", 70, HorizontalAlignment.Left);
            LVbill.Columns.Add("Name", 120, HorizontalAlignment.Left);
            LVbill.Columns.Add("Qty", 100, HorizontalAlignment.Left);
            LVbill.Columns.Add("Bill AMT", 100, HorizontalAlignment.Left);
            LVbill.Columns.Add("Cash AMT", 100, HorizontalAlignment.Left);
            LVbill.Columns.Add("Other AMT", 100, HorizontalAlignment.Left);
        ...
        public ListPOS(DefaultPOS defaultPOS, TabControl tabControl)
        {
            // TODO: Complete member initialization
            InitializeComponent();
            LVbill.Columns.Add("Date", 100, HorizontalAlignment.Center);
        ...
        public ListPOS(DefaultPOS defaultPOS, Master master, TabControl tabControl)
        {
            // TODO: Complete member initialization
            InitializeComponent();
            LVbill.Columns.Add("Date", 100, HorizontalAlignment.Center);
        ...
        public void listviewbind1()
        {
            try
            {
                ...
                for (int i = 0; i <= dt.Rows.Count - 1; i++)
                {
                    ...
                    LVbill.Items[i].SubItems.Add(dt.Rows[i].ItemArray[11].ToString());
            ...
            try
            {
                ...
                if (dr1 == DialogResult.Yes)
                {
                    if (LVbill.Items.Count > 0)
                    {
                        ...
                        {
                            string a = "", b = "", c = "", d = "", s = "", f = "", g = "", h = "", q = "", j = "", k = "", l = "";
                            ...
                            j = LVbill.Items[i].SubItems[9].Text;
                            k = LVbill.Items[i].SubItems[10].Text;
                            l = LVbill.Items[i].SubItems[11].Text;
                            if (f == "" || f == null)
                            {
                                f = "0";
                            }
        ...
        private void _BindPOSListDetails()
        {
