...
namespace RamdevSales
{
    ...
    public partial class StockinoutList : Form
    {
        ...
        public StockinoutList()
        {
            InitializeComponent();
        }

        public StockinoutList(Master master, TabControl tabControl)
        {
        ...
        public StockinoutList(Master master, TabControl tabControl, string[] strfinalarray)
        {
            // TODO: Complete member initialization
            InitializeComponent();
            this.master = master;
        ...
        private void btnnew_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Stockinout bd = new Stockinout(master, tabControl, strfinalarray);
        ...
        public void setform()
        {
            try
            {
                ...
                DataTable dt1 = conn.getdataset("select * from FormFormat where isactive=1 and type='" + strfinalarray[0] + "' and setdefault=1");
                bd = new Stockinout(this, master, tabControl, strfinalarray);
                ...
                if (dr1 == DialogResult.Yes)
                {
                    if (LVDayBook.Items.Count > 0)
                    {
                        ...
                        for (int i = 0; i < LVDayBook.Items.Count; i++)
                        {
                            ...
                            if (txttitle.Text == "STOCK IN LIST")
                            {
                                SaleList = "STOCK IN LIST FROM " + DTPFrom.Text + " To " + DTPTo.Text;
                            }
                            else if (txttitle.Text == "STOCK OUT LIST")
                            {
                                SaleList = "STOCK OUT LIST FROM " + DTPFrom.Text + " To " + DTPTo.Text;
                            }
                        ...
                        string reportName = "STOCKINOUTBillsList";
        ...
        private void bindsearch()
        {
            ...
            {
                qry += "and (" + drpaccount.Text + " like '%" + txtaccount.Text + "%')";
            }
            else if (txtaccount.Text != "" && txtitems.Text != "")
            {
                qry += "and (" + drpaccount.Text + " like '%" + txtaccount.Text + "%' and " + drpitems.Text + " like '%" + txtitems.Text + "%')";
            }
            else if (txtaccount.Text == "" && txtitems.Text != "")
            {
                qry += "and (" + drpitems.Text + " like '%" + txtitems.Text + "%')";
            }
